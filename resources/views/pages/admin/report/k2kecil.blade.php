                ...
                <div class="row mt-3 p-3">
                    <div class="col-lg-3">
                        ...
                        <select class="form-select filter" aria-label="Default select example" id="kelas" name="kelas">
                            ...
                            <option value="1AK2">1AK2</option>
                            <option value="1BK2">1BK2</option>
                            <option value="2AK2">2AK2</option>
                            <option value="2BK2">2BK2</option>
                            <option value="3AK2">3AK2</option>
                            <option value="3BK2">3BK2</option>
                        </select>
                    </div>
                    <div class="col-lg-3">
                        <label for="" style="margin-bottom: 7px; font-weight:bold">Kelas</label>
