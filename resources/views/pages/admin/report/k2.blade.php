                ...
                <div class="row mt-3 p-3">
                    <div class="col-lg-3">
                        ...
                        <select class="form-select filter" aria-label="Default select example" id="kelas" name="kelas">
                            ...
                            <option value="4AK2">4AK2</option>
                            <option value="4BK2">4BK2</option>
                            <option value="5AK2">5AK2</option>
                            <option value="5BK2">5BK2</option>
                            <option value="5CK2">5CK2</option>
                            <option value="6AK2">6AK2</option>
                            <option value="6BK2">6BK2</option>
                        </select>
                    </div>
                    <div class="col-lg-3">
                        <label for="" style="margin-bottom: 7px; font-weight:bold">Kelas</label>
                    ...
                    <div class="col-lg-3">
                        ...
                        {{-- <input type="text" class="form-control" id="filter-tanggal" name="tanggal"> --}}
                    </div>
                </div>
