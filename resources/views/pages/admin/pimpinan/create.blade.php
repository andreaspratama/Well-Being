    ...
    <main id="main-container">
        ...
        <div class="content">
            ...
            <div class="block block-rounded">
                ...
                <h3 class="block-title">Tambah Pimpinan</h3>
                </div>
                ...
                <form action="{{route('pimpinan.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-8 col-xl-12">
                        ...
                        <input type="text" class="form-control" id="example-email-input" name="email" placeholder="Email">
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="example-email-input" name="status" placeholder="Status">
                        </div>
                        <div>
