    ...
    <main id="main-container">
        ...
        <div class="content">
            ...
            <div class="block block-rounded">
                ...
                <h3 class="block-title">Edit Pimpinan</h3>
                </div>
                <div class="block-content block-content-full">
                <form action="{{route('pimpinan.update', $item->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row push">
                    <div class="col-lg-8 col-xl-12">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" id="example-select" name="unit">
                              ...
                              <option value="MANAJERIAL" @if($item->unit == 'MANAJERIAL') selected @endif>MANAJERIAL</option>
                            </select>
                        </div>
                        <div class="mb-4">
                            <label class="form-label" for="example-email-input">Status</label>
                            <input type="text" class="form-control" id="example-email-input" name="status" placeholder="Status" value="{{$item->status}}">
                            </div>
                        <div>
                        <div>
