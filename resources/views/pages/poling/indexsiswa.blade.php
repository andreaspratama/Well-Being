...
<body>
  ...
  <main id="main">
    ...
    <section class="inner-page">
      <div class="container">
        <div class="nama" style="font-size: 30px; margin-bottom: 20px">
        ...
        <div class="block block-rounded">
            ...
            <div class="block-content block-content-full">
              ...
              @else
                      ...
                      <div class="row push">
                        ...
                        <div class="col-lg-8 col-xl-5">
                          <div class="mb-5">
                            ...
                            <textarea class="form-control @error('cerita') is-invalid @enderror" id="exampleFormControlTextarea1" rows="3" name="cerita"></textarea>
                            @error('cerita')
                ...
                @else
                    <h4>Sorry, belum saatnya mengisi feedback, belajar dulu yaaa setelah itu kembali kesini lagi :)</h4>
                @endif
              @endif
            </div>
        </div>
